...
namespace StockMarket.Adapter
{
    public class RdotNetAdapter : IRdotNetAdapter
    {
        ...
        // new imp 
        public IEnumerable<MACDIndex> CalculateMACDIndex(IEnumerable<TimeSeries> input)
        {
        ...
        public IEnumerable<RSIIndex> CalculateRSIIndex(IEnumerable<TimeSeries> input)
        {
        ...
        public IEnumerable<SOIndex> CalculateSOIndex(IEnumerable<TimeSeries> input)
        {
        ...
        public IEnumerable<GuppyIndex> CalculateGuppyIndex(IEnumerable<TimeSeries> input)
        {
            var StockDataFrame = RDotNetConvertor.TimeSeriesToDataFrame(input, engine);
            engine.SetSymbol("datasets", StockDataFrame);
